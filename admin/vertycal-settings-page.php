...
function vertycal_register_admin_options() 
{
    ...
    add_settings_field(
        ...
        array( 
            ...
            'value'       => vertycal_options_getter_checkbox('vertycal_users_caps', false ),
            'description' => esc_html__( 'Check to allow user to see and edit only their own posts.', 
                             'vertycal' ),
            'checked'     =>  esc_attr( checked( 1, 
            vertycal_options_getter_checkbox('vertycal_users_caps', false ) ) ),
    ...
    // c.6.) checkbox field vertycal_state_checkbox_showyear 
    add_settings_field(
        ...
        array( 
            ...
            'value'       => vertycal_options_getter_checkbox('vertycal_checkbox_markdone', false ),
            'description' => esc_html__( 'Check to have access to marking status publically.',
                                         'vertycal' ),
            'checked'     => esc_attr( checked( 1, 
            vertycal_options_getter_checkbox('vertycal_checkbox_markdone', false ) ) ),
    ...
    add_settings_field(
        ...
        array( 
            ...
            'value'       => vertycal_options_getter_checkbox('vertycal_checkbox_showyear', false ),
            'description' => esc_html__( 'Check to remove year display from Scheduler.',
                                         'vertycal' ),
            'checked'     => esc_attr( checked( 1, 
            vertycal_options_getter_checkbox('vertycal_checkbox_showyear', false ) ) ),
    ...
    add_settings_field(
        ...
        array( 
            ...
            'value'       => vertycal_options_getter_checkbox('vertycal_dashnews_widgetcheck', false),
            'description' => esc_html__( 'Check to remove some WordPress Dashboard widgets and re-brand controls with custom colors.', 
                             'vertycal' ),
            'checked'     =>  esc_attr( checked( 1, 
            vertycal_options_getter_checkbox('vertycal_dashnews_widgetcheck', false ) ) ),
...
{  
   printf(
    '<fieldset><b class="vrttip" data-title="%6$s">?</b><sup>6</sup>
...
$schedulertheme_url = 'http://vertycal.net/documentation/'; 
...
<tr>
<td>Public Heading Title</td><td> vertycal_text_field_0</td><td></td></tr><tr>
<td>Page Name of Scheduler</td><td> vertycal_text_field_1</td><td></td></tr><tr>
<td>Email to Send Fulfilled</td><td> vertycal_email_field_1</td><td></td></tr><tr>
<td>Single Page Margin</td><td> vertycal_text_field_2</td><td></td></tr><tr>
<td>Limit User Data</td><td> vertycal_users_caps</td><td></td></tr><tr>
<td>Mark Complete Usage</td><td> vertycal_checkbox_markdone</td><td></td></tr><tr>
<td>Add Custom Dashboard Widget</td><td> vertycal_dashnews_widgetcheck</td><td></td></tr>
</tbody></table>
<hr>
<br>
